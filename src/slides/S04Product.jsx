...
function MockupUI({ view, setView, scaleIdx, shrink, grow, onToggleFull, fullscreen }) {
      ...
      <div className="mock-bar">
        <div className="mock-dots">
          <div
            ...
            title={fullscreen ? 'Fechar' : 'Expandir'}
...
export default function S04Product() {
  ...
  const [scaleIdx, setScaleIdx] = useState(3);
  ...
  const uiProps = { view, setView, scaleIdx, shrink, grow, onToggleFull: toggleFull, fullscreen };
  ...
  return (
    <>
      <div className="slide-inner prod-slide-inner">
        ...
        <div className="mockup" style={fullscreen ? { visibility: 'hidden' } : {}}>
          <MockupUI {...uiProps} />
        </div>
      </div>
      ...
      {fullscreen && createPortal(
        <div className="s-product">
          <div
            className="mockup-backdrop"
            onClick={toggleFull}
          />
          <div className="mockup mockup--popup">
            <MockupUI {...uiProps} />
          </div>
        </div>,
        document.body
