...
* [English](auto-animate.md) [繁體中文](auto-animate.md)

* Languages
  + [English](auto-animate.md)
  + [繁體中文](auto-animate.md)
* Getting Started
  + [Home](index.md)
  + [Demo](/?demo)
...
<section data-auto-animate>
  <ul>
<li>Mercury</li><li>Jupiter</li><li>Mars</li>  </ul>
</section>
<section data-auto-animate>
  <ul>
    <li>Mercury</li>
<li>Earth</li>    <li>Jupiter</li>
<li>Saturn</li>    <li>Mars</li>
  </ul>
</section>
```
